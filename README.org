...
** Books 
   - [[https://www.amazon.com/Python-Data-Analysis-Wrangling-IPython/dp/1491957662/ref=sr_1_2?s=books&ie=UTF8&qid=1522206082&sr=1-2&keywords=pandas][Python for Data Analysis: Data Wrangling with Pandas, NumPy, and IPython 2nd Edition]]  it is available online from [[https://du-primo.hosted.exlibrisgroup.com/primo-explore/search?query=any,contains,Python%2520for%2520Data%2520Analysis:%2520Data%2520Wrangling%2520with%2520Pandas%2520%2520NumPy%2520%2520and%2520IPython%25202nd%2520Edition&search_scope=everything_scope&sortby=rank&vid=01UODE_MAIN&lang=en_US&mode=Basic][library]]
*** other books     
...
|---------+------------------------------------------------------------------------|
|         | Python library for visualization *Bokesh, matlpoltlib*                 |
|---------+------------------------------------------------------------------------|
...
|            |                                           | Please install required python software as mentionde in Python section.                          |
|            | https://github.com/QCaudron/pydata_pandas | use *jupyter notebook* from the folder where your notebook  resides to start working on notebook |
